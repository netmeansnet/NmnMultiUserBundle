...
class OrmUserManagerTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->metadata->expects($this->exactly(1))->method('getName')->will($this->onConsecutiveCalls('PUGX\MultiUserBundle\Tests\Stub\User'));
    ...
    {                
        ...
        $metadata->expects($this->exactly(1))->method('getName')->will($this->onConsecutiveCalls('PUGX\MultiUserBundle\Tests\Stub\User'));
